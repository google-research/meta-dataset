...
Meta-Dataset is now compatible with Python 2 and Python 3, please report any
glitch with Python 3. The code has not been tested with TensorFlow 2 yet.
...
We will try our best to reproduce the original results using the public code on
Google Cloud VMs, and we will include the results of the reproduced experiments
in the future.
